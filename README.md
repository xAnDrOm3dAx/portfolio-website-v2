...
A one-page portfolio for Christopher Werkmeister, a Sunshine Coast-based Web Developer. The site is static HTML, CSS, and JavaScript, designed to work on GitHub Pages without a build step.
